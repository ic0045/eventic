...
export async function sendConfirmEmail (email : string, id : string) :Promise<boolean>{
    ...
    const msg = {
        ...
        html: createConfirmEmailBody(redirectLink),
    }
    try{ 
...
export async function sendRecoveryEmail (email : string, id : string) :Promise<boolean>{
    ...
    const msg = {
        ...
        html: createRecoveryEmailBody(redirectLink),
    }
    try{ 
        let res = await sgMail.send(msg);
        if (res[0].statusCode == 202) return true;
...
/*
* Cria corpo de e-mail de recuperação de senha com link de redirecionamento informado
*/
function createRecoveryEmailBody(redirectLink : string) : string{
    return `<div style="box-sizing:border-box;display:block;max-width:600px;margin:0 auto;padding:10px"><span style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;width:0">Verifique seu e-mail.</span>
                ...
                <table style="box-sizing:border-box;width:100%;border-spacing:0;border-collapse:separate!important" width="100%">
                    <tbody>
                        <tr>
                            ...
                            <h2 style="margin:0;margin-bottom:30px;font-family:'Open Sans','Helvetica Neue','Helvetica',Helvetica,Arial,sans-serif;font-weight:300;line-height:1.5;font-size:24px;color:#294661!important">Para concluir a alteração de senha, clique no botão abaixo.</h2>
                            </td>
                        </tr>
                        <tr>
                            <td style="box-sizing:border-box;padding:0;font-family:'Open Sans','Helvetica Neue','Helvetica',Helvetica,Arial,sans-serif;font-size:16px;vertical-align:top" valign="top">
...
/*
* Cria corpo de e-mail de confirmação com link de redirecionamento informado
*/
function createConfirmEmailBody(redirectLink : string) : string{
    return `<div style="box-sizing:border-box;display:block;max-width:600px;margin:0 auto;padding:10px"><span style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;width:0">Verifique seu e-mail.</span>
    <div style="box-sizing:border-box;width:100%;margin-bottom:30px;margin-top:15px">
    <table style="box-sizing:border-box;width:100%;border-spacing:0;border-collapse:separate!important" width="100%">
        <tbody>
            ...
            <tr>
                ...
                <table style="box-sizing:border-box;width:100%;border-spacing:0;border-collapse:separate!important" width="100%">
                    <tbody>
                        <tr>
                            <td style="box-sizing:border-box;padding:0;font-family:'Open Sans','Helvetica Neue','Helvetica',Helvetica,Arial,sans-serif;font-size:16px;vertical-align:top" valign="top">
                            <h2 style="margin:0;margin-bottom:30px;font-family:'Open Sans','Helvetica Neue','Helvetica',Helvetica,Arial,sans-serif;font-weight:300;line-height:1.5;font-size:24px;color:#294661!important">Para concluir o cadastro no EventIC, verifique seu e-mail.</h2>
                            </td>
                        </tr>
                        <tr>
                            <td style="box-sizing:border-box;padding:0;font-family:'Open Sans','Helvetica Neue','Helvetica',Helvetica,Arial,sans-serif;font-size:16px;vertical-align:top" valign="top">
