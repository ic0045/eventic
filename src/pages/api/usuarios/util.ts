...
export async function sendConfirmEmail (email : string, id : string) :Promise<boolean>{
    ...
    const msg = {
        ...
        html: createEmailBody(redirectLink),
    }
    try{ 
        let res = await sgMail.send(msg);
        console.log("Email enviado com resposta = "+res[0].statusCode);
...
/*
* Cria corpo de e-mail com link de redirecionamento informado
*/
function createEmailBody(redirectLink : string) : string{
